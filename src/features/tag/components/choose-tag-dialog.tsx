                ...
                {tags?.map((tag) => (
                  <Button 
                    ...
                    className={selectionTag.includes(tag) 
                      ? "flex flex-row gap-5 justify-start bg-green-200 hover:bg-green-300 border-green-400 border-2"
                      : "flex flex-row gap-5 justify-start bg-transparent hover:bg-muted"}
